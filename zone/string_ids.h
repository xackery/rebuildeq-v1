...
#define RB_NEC_IMPARTSTRENGTH 36 // RB_NEC_ARMOROFDEATH
#define RB_NEC_BLOODREALM 38
#define RB_NEC_DEATHLYAURA 40
#define RB_NEC_SHADOWTAP 42 // RB_NEC_BURDENOFUNDEATH
#define RB_NEC_DEATHBLOOM 44 
#define RB_NEC_CRIPPLINGCLAUDICATION 46 // RB_NEC_ETERNITYOFUNDEATH
#define RB_NEC_DEGENERATION 49 // RB_NEC_GHOULCLAWS
